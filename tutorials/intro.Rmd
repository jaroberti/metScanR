...
This tutorial is intended for users that are both familiar and unfamiliar with R. The R code higlighted below can be copy-pasted and executed inside an R script. 
...
* Practical Use Cases
    ...
    * Find multiple variables of interest where sensors/measurements are co-located
...
* data\$stationid\$identifiers **(associated MET networks)** [example: data\$USW00094893\$identifiers]
    ...
    * data\$stationid\$platform __(primary MET network)__
